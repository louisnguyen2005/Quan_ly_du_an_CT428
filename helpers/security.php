...
function require_action_role(string $action): void
{
    ...
    $rules = [
        ...
        // Admin chỉ xem dự án/nhiệm vụ; thao tác tạo thuộc Manager.
        'createProject' => [ROLE_MANAGER],
        'createTask' => [ROLE_MANAGER],
        ...
        'openNotification' => [ROLE_ADMIN, ROLE_MANAGER, ROLE_STAFF],
    ];
