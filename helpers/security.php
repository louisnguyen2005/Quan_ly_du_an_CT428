...
function require_action_role(string $action): void
{
    ...
    // Admin chỉ giám sát hệ thống; việc tạo dự án/nhiệm vụ thuộc Manager.
    if (in_array($action, ['createProject', 'createTask'], true)) {
        app_forbidden('Admin không được tạo dự án hoặc nhiệm vụ. Vui lòng sử dụng tài khoản Manager.');
    }
