...
$cnt->execute(manager_owned_project_params($managerId));
...
$doing->execute(manager_owned_project_params($managerId));
...
$future->execute(manager_owned_project_params($managerId));
...
$done->execute(manager_owned_project_params($managerId));
