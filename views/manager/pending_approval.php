...
<div class="manager-modal-backdrop" id="approvalDetailModal">
    <div class="manager-modal task-detail-modal">
        <div class="manager-modal-header">
            ...
            <button class="manager-btn light icon" data-close-modal="approvalDetailModal"><i
        ...
        <div class="manager-modal-footer">
            ...
            <button type="button" class="manager-btn primary" id="approvalApproveBtn"><i
                    class="bi bi-check2-circle"></i> Approve</button>
            <button type="button" class="manager-btn danger" id="approvalRejectBtn"><i class="bi bi-x-circle"></i>
                Reject</button>
        </div>
    </div>
</div>
...
<div class="manager-modal-backdrop" id="rejectReasonModal">
    <div class="manager-modal reject-reason-modal">
        <div class="manager-modal-header">
            ...
            <button class="manager-btn light icon" data-close-modal="rejectReasonModal"><i
                    class="bi bi-x-lg"></i></button>
        </div>
        <div class="manager-modal-body">
            ...
            <div class="form-group full">
                ...
                <div class="reject-reason-footer-row">
                    <span class="reject-reason-error" id="rejectReasonError"><i class="bi bi-exclamation-circle"></i>
                        Vui lòng nhập lý do từ chối.</span>
        ...
        <div class="manager-modal-footer">
            ...
            <button type="button" class="manager-btn danger" id="confirmRejectBtn"><i class="bi bi-x-circle"></i> Từ
                chối</button>
        </div>
    </div>
</div>
