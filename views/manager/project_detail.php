...
$stmt->execute(array_merge(['id' => $id], manager_owned_project_params($managerId)));
...
<div class="manager-shell">
    <?php manager_sidebar($manager, 'projects', $sidebarProjectCount, $sidebarTaskCount, $sidebarNotifCount, $sidebarPendingApprovalCount); ?>
