...
<div class="manager-shell">
    <?php manager_sidebar($manager, 'notifications', $projectCount, $taskCount, $notifCount, $pendingApprovalCount); ?>
                    ...
                    <?php foreach ($notifications as $item): ?>
                        <?php
                            ...
                            if ($nType === 'task_approval' && $relatedId > 0) {
                                $notifLink = 'index.php?action=openNotification&id=' . (int)$item['notification_id'] . '&_csrf_token=' . urlencode(csrf_token());
