        ...
        <div class="staff-modal-body">
            ...
            <form id="staffTaskProgressForm" enctype="multipart/form-data">
                ...
                <div class="staff-progress-grid">
                    <label>
                        <span>Progress (%)</span>
                        <input type="number" min="0" max="100" name="progress_percent" id="staffProgressPercent" required>
                    </label>
                    <label>
                        <span>Status</span>
                        <select name="status" id="staffProgressStatus" required>
                    ...
                    <label class="staff-progress-full">
                        <span>Comment</span>
                        <textarea name="progress_comment" id="staffProgressComment" rows="4"></textarea>
                    </label>
                    <label class="staff-progress-full">
                ...
                <div class="staff-modal-actions">
                    <button class="staff-secondary-btn" type="button" id="staffSaveDraftBtn">Save Draft</button>
                    <button class="staff-primary-btn" type="submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
