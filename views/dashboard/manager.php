    ...
    <div class="manager-shell">
        <aside class="manager-sidebar">
            ...
            <nav class="manager-menu">
                <a href="#overview" class="manager-menu-item active"><i class="bi bi-house-fill"></i><span>Tổng
                        quan</span></a>
                <a href="index.php?page=projects" class="manager-menu-item"><i class="bi bi-folder"></i><span>Dự
                        án</span><span class="manager-badge-count"><?= $sidebarProjectCount ?></span></a>
                <a href="index.php?page=tasks" class="manager-menu-item"><i class="bi bi-check2-square"></i><span>Nhiệm
                        vụ</span><span class="manager-badge-count"><?= $sidebarTaskCount ?></span></a>
                <a href="index.php?page=notifications" class="manager-menu-item"><i class="bi bi-bell"></i><span>Thông
                        báo</span><span class="manager-badge-count red"><?= $sidebarNotifCount ?></span></a>
            </nav>
