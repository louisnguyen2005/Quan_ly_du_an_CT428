...
$db = new Database();
$pdo = $db->connect();
// Dashboard cũ dùng cùng một named placeholder nhiều lần trong một câu SQL.
// Bật emulated prepares riêng cho trang này để PDO bind an toàn và tránh HY093.
...
$managedProjectWhere = "p.manager_id = :manager_id";
        ...
        <main class="manager-main-content">
            <header class="manager-topbar">
                ...
                <div class="manager-topbar-right">
                    <div class="manager-search-box global-search-container">
                        <i class="bi bi-search"></i>
                        <input
                            type="search"
                            id="managerGlobalSearch"
                            class="global-search-input"
                            autocomplete="off"
                            placeholder="Tìm kiếm dự án, nhiệm vụ..."
                            aria-label="Tìm kiếm dự án và nhiệm vụ"
                        >
