                ...
                <div class="card" style="text-align:center; padding:32px 24px;">
                    <div style="width:120px; height:120px; margin:0 auto 16px;">
                        <img src="assets/images/abc.png" alt="avatar"
                             style="width:100%; height:100%; border-radius:50%; object-fit:cover; border:4px solid var(--border-color);">
                    </div>
                    ...
                    <button type="button" class="btn-primary" style="width:100% !important; height:44px;">
                        <i class="fa-regular fa-image"></i> Chỉnh sửa ảnh
                    </button>
                </div>
            </div>
