...
$avatarInitial = mb_strtoupper(mb_substr(trim($username) ?: 'U', 0, 1, 'UTF-8'), 'UTF-8');
...
<header class="topbar">
    ...
    <div class="topbar-right">
        ...
        <div class="profile" id="profileToggle" style="position: relative; cursor: pointer; user-select: none;">
            <span class="profile-avatar-initial" aria-label="Avatar"><?= htmlspecialchars($avatarInitial) ?></span>
